...
class CameraSharedPrefs (val context: Context)  {

    protected val prefs = context.getSharedPrefs()

    companion object {
        fun newInstance(context: Context) = CameraSharedPrefs(context)
    }

    var savePhotosFolder: String
        get(): String {
            val path = if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) || !Environment.isExternalStorageRemovable()) {
